                    ...
                    <div class="auth-body">
                        ...
                        <form method="post">
                            ...
                            <button type="submit" class="btn btn-neon w-100 py-2 mb-3">
                                <i class="bi bi-lock-fill"></i> Se connecter
                            </button>
                            
                            <div class="auth-footer">
                                <p class="mb-2">Pas encore de compte ? <a href="register.php">Créez-en un</a></p>
                                <p class="mb-0"><a href="forgot_password.php" class="secondary-link">Mot de passe oublié ?</a></p>
                            </div>
                        </form>
                    </div>
                </div>
